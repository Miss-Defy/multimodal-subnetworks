...
#SBATCH -o /home/users/elatash1/Work/Joanne_Multimodal/multimodal-subnetworks-main-groupnorm-claude/slurm_scripts/out_Joanne_multimodal_%A_group_norm_worldsize.out 
#SBATCH -A psy53c17
sleep 10s
...
# for SPARSITY in 0.3 0.5 0.7; do
    ...
    python3 train_script_rev.py \
        ...
        --config-dir conf \
        experiment.experiment_name=${dataset}_${modality}_lz4_sps${SPARSITY} \
